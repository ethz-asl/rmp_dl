set(LIBRARY_NAME kernelBindings)

add_library(${LIBRARY_NAME} SHARED
        src/bindings/kernel_bindings.cc
        src/kernels/get_rays.cu
        )

set_property(TARGET ${LIBRARY_NAME} PROPERTY CMAKE_CUDA_SEPARABLE_COMPILATION ON)
