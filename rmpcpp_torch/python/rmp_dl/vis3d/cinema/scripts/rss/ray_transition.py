...
def main():
    ...
    directory = rmp_io.resolve_directory("media/videos/presentationRSS/ray_transition")
    # directory = None

    Studio.do_run_and_make_video(md, output_directory=directory, filename="ray_transition.mp4", delete_images=False)
